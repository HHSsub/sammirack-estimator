...
scp -r "C:\Users\삼미2\Downloads\sammirack-estimator\네이버커머스_발주서자동연결" root@139.150.11.53:/opt/sammirack/

# 서버에서 디렉토리 확인
ls -la /opt/sammirack/네이버커머스_발주서자동연결/
```
...
Type=simple
User=root
WorkingDirectory=/opt/sammirack/네이버커머스_발주서자동연결
ExecStart=/opt/sammirack/네이버커머스_발주서자동연결/venv/bin/python3 order_listener.py
Restart=always
RestartSec=10
...
# 저장된 주문 CSV 확인
cat /opt/sammirack/네이버커머스_발주서자동연결/order_logs/orders_$(date +%Y-%m).csv
```
