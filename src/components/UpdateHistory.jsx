...
const UpdateHistory = () => {
  ...
  const updates = [
    // 새로운 업데이트는 여기에 추가하세요
    { date: '2025-03-13', content: '오류 수정: 파렛트랙 규격(4500 이상) 표시 버그 해결 / UI/UX 개선: 용어 변경(청구서→발주서), 가독성 향상(스토어 번호·규격 파란색 및 글자 확대), 제품 선택 순서 재정렬 / 출력 최적화: 빈 줄 높이 축소로 용지 절약 및 인쇄 디자인 통일 / 신규 기능: 문서관리 탭 내 ‘일괄 인쇄’ 기능 도입' },
