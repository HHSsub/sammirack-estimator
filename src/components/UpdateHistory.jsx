...
const UpdateHistory = () => {
  ...
  const updates = [
    // 새로운 업데이트는 여기에 추가하세요
    { date: '2025-03-06', content: '견적서 화면에서 청구서 즉시전환가능, 품목추가 버튼에서 하이랙 기둥 높이글자제거, 파렛트랙 기둥은 브러시랑 세트로, 스마트스토어 문서 자동저장 개선' },
    { date: '2025-02-27', content: '자재 추가 버튼에서 규격 빨간글씨, 하이랙 기둥부터 먼저보이게, 스마트스토어API 자동 청구서 저장로직 실험적 구현' },
