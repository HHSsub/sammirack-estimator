  ...
  return (
    <div style={{ padding: 20, background: '#f8fcff', borderRadius: 8, marginBottom: 20 }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, marginBottom: 12 }}>
        ...
        {/* 제품 유형은 항상 표시 (allOptions.types 기반) */}
        <div style={{ minWidth: 160 }}>
          <label style={{ fontWeight: 600, fontSize: 15, display: 'block', marginBottom: 4 }}>제품 유형</label>
          <select
            disabled={loading}
            value={selectedType}
      ...
      <div style={{ marginTop: 12, display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        <button onClick={addToCart} disabled={!selectedType}
          style={{ padding: '4px 12px', background: '#2556a0', color: '#fff', border: 'none', borderRadius: 4 }}>
          목록 추가
        </button>
      </div>
    </div>
