# 프로젝트 전체 분석 보고서
- 작성일 : 2026.01.01 (지속 업데이트 필요) // 2026.01.27 대규모 업데이트했으니 반드시 수정해야함 (gist버리고 api새로)

## 프로젝트 개요

**이름/목적:**
- **sammirack-estimator** - (주)삼미앵글 랙(선반) 견적 및 재고 관리 시스템
- 랙 제품(경량랙, 중량랙, 파렛트랙, 하이랙, 스텐랙 등)의 BOM 생성, 가격 계산, 견적서/발주서 작성, 재고 관리 기능 제공
...
- 기능:
  ...
  - `convertEstimateToPurchaseOrder()`: 견적서 → 발주서 변환
...
- `PurchaseOrderForm.jsx`: 발주서 작성/편집
